...
These requirement are formulated using {doc}`information structures <../how_it_works/alg_properties>` and  {doc}`repeated operator evaluation <../usage/problem_formulation/system/bind>`. The associated inclusions and  information structure at $h=3$ is 
\begin{align*}
