...
Configuration options include numerical tolerances and  recovery options, and are detailed in {doc}`Configuration <../../documentation/doc_config>`.

The sparsity pattern of the controller $D_K$ in synthesis can be assigned in the configuration options. This sparsity pattern can be used to enforce an [Information Structure](project:#information-structure) on the generated algorithm.
