classdef opt_config_tol
    ...
    properties
        dia= 1e-9;   %tolerance for acceptable solution 
        M= 1e-8;      %tolerance for dissipation constraints
        X=  1e-8;     %tolerance for sign/terminal cost constraints 
        G_max=  1000;  %upper bound on norm of storage matrix (analysis)
    ...
    input_diss=  1e-5;%tolerance for strict input dissipation
