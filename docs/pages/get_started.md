...
\begin{align*}
 ...
 I & -0.133 I & -0.449 I & -0.316 I }   \mat{c}{x_{k+1}^1 \\ x_{k+1}^2 \hl w_k^1 \\ w_k^2}, & \mat{c}{w_k^1 \\ w_k^2} \in  \mat{c}{\partial f(z_k^1) \\ \partial \partial \mathbb{I}_{\mathcal{Z}}(z_k^2)}
\end{align*}.
```
